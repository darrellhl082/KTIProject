...
<body>
    ...
    <div class="container main justify-content-center align-items-center align-content-center">
        ...
        <div class="row mt-5 text-black mb-5">
            <div class="col-md-8">
                <form name="uploadArticle" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="content" class="form-label">Upload Text</label>
                        <textarea class="form-control bg-transparent border-dark" id="content" name="content" rows="3"
                            required></textarea>
                    </div>
