        ...
        <div class="row mt-4">
            ...
            <div class="col-md-3 mb-3">
                <div class="card bg-transparent">
                    ...
                    <img src="article/img/<?php echo $key["thumb"] ?>" class="card-img-top img-fluid" alt="...">
                    <div class="card-body">
                        <h5 class="card-title"> <?php echo $key["title"] ?></h5>
                        <p class="card-text text-mute text-secondary"> <?php echo $key["theme"] ?></p>
                        <a href="article/index.php?id=<?php echo $key["idArticle"] ?>"
                            class="btn btn-outline-dark">Read</a>
                    </div>
                </div>
            </div>
            <?php endforeach ?>
